...
Submit all changes directly to the [main](https://github.com/Doist/todoist-cli/tree/main) branch (via PR). We do our best to keep `main` in good shape, with all tests passing.
